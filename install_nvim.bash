...
directory_exists_with_spaces "${USER_HOME}"
 ...
 #--------\/\/\/\/-- Work here below \/, test, and transfer to tasks_templates/nvim having a working version -\/\/\/\/-------





 #--------/\/\/\/\-- Work here above /\, test, and transfer to tasks_templates/nvim having a working version -/\/\/\/\-------
