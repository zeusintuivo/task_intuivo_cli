...
_fedora_37__64(){
  trap  '_trap_on_error $0 "${?}" LINENO BASH_LINENO FUNCNAME BASH_COMMAND $FUNCNAME $BASH_LINENO $LINENO   $BASH_COMMAND'  ERR
  PROJECTREPO=/home/zeus/_/work/intuivo/projects/ical_fetch_rust
...
_brew_check_requirements_postgress_12_install() {
  ...
  # {
    ...
    Comment "LINENO:$LINENO brew stuff ${_target_bin_brew} "
	  set -x
    if [ ${found} -eq 1  ]  ; then
    {
  ...
  set +x
  Comment "### install_requirements  darwin ${_target_bin_brew}"
