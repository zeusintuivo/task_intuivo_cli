...
_checka_tools_commander(){
    ...
    # is_not_installed tree &&  $COMANDDER tree
    # is_not_installed ag &&    $COMANDDER the_silver_searcher
    # is_not_installed ag &&    $COMANDDER silversearcher-ag  # Ubuntu only
    # is_not_installed ack &&   $COMANDDER ack
    # is_not_installed ack &&   $COMANDDER ack-grep           # Ubuntu only
    # is_not_installed pv &&    $COMANDDER pv
...
_darwin__64() {
    COMANDDER="su $SUDO_USER -c brew install"
    echo mac?
