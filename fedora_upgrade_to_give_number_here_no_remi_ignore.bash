...
function main(){
  ...
  sudo dnf upgrade --refresh   -y --allowerasing --nobest

  sudo dnf distro-sync -y --allowerasing --nobest
	...
	sudo dnf system-upgrade download --releasever=${target}  -y --allowerasing --nobest
