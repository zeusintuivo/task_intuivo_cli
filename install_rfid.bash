...
directory_exists_with_spaces "${USER_HOME}"
 ...
 #--------\/\/\/\/-- 2tasks_templates_sudo/rfid …install_rfid.bash” -- Custom code -\/\/\/\/-------
...
_redhat_flavor_install() {
  trap  '_trap_on_error $0 "${?}" LINENO BASH_LINENO FUNCNAME BASH_COMMAND $FUNCNAME $BASH_LINENO $LINENO   $BASH_COMMAND'  ERR
	echo "REF: https://github.com/Giraut/rpm"

	yes | dnf config-manager --add-repo https://raw.githubusercontent.com/Giraut/rpm/master/giraut.repo
	dnf update -y
  if (
  install_requirements "linux" "
    unzip
  ...
  dnf install https://raw.githubusercontent.com/Giraut/rpm/master/python3-pyufr-0.4.0-0.noarch.rpm -y
	echo "REF:https://github.com/Giraut/SiRFIDaL?tab=readme-ov-file"
