...
directory_exists_with_spaces "${USER_HOME}"
 ...
 #--------\/\/\/\/-- 2tasks_templates_sudo/taskwarrior …install_taskwarrior.bash” -- Custom code -\/\/\/\/-------
...
_redhat_flavor_install() {
  ...
  echo "Task should be installed  Procedure not yet extended. I don't know what to do now... "
