...
_darwin__64() {
  ...
  enforce_variable_with_value USER_HOME "${USER_HOME}"
  enforce_variable_with_value USER_HOME "${USER_HOME}"
  anounce_command "su - '${SUDO_USER}' -c 'brew install vim'"
  anounce_command "curl -fLo '${USER_HOME}/.vim/autoload/plug.vim' --create-dirs \
    https://raw.githubusercontent.com/junegunn/vim-plug/master/plug.vim"
  anounce_command "chown -R '${SUDO_USER}' '${USER_HOME}/.vim/'"
  # anounce_command "curl -fLo '/root/.vim/autoload/plug.vim' --create-dirs \
  #  https://raw.githubusercontent.com/junegunn/vim-plug/master/plug.vim"
