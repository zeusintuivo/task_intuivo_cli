...
Installing This will take about 45 minutes.
...
Bash on Ubuntu on Windows is the name for the Linux
Subsystem that's in beta right now for Windows.
It allows you to run Linux on Windows without having to run a VM.
"
...
echo "Postgresql installation currently fails on
creating the default cluster. could not create
shared memory segment: Function not implemented
We currently don't have any fixes for this, so
we recommend using MySQL for now.
"
